...
use App\Filament\Admin\Resources\ExpertRequestResource\Pages;
...
class ExpertRequestResource extends Resource
{
    protected static ?string $model = ExpertRequest::class;
    ...
    {
        return __('general.expert_requests'); // TODO: Change the autogenerated stub
    }
    ...
    {
        return [
            'index' => Pages\ListExpertRequests::route('/'),
            //            'create' => Pages\CreateExpertRequest::route('/create'),
            'edit' => Pages\EditExpertRequest::route('/{record}/edit'),
            'view' => Pages\ViewExpertRequest::route('/{record}'),
        ];
    }
}
