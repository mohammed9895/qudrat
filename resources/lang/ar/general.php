...
return [
    ...
    'team' => [
          'title' => 'فريق تطوير منصة قدرات',
        'subtitle' => 'الإسهام في بناء المنظومة الوطنية لبناء القدرات وإدارة المواهب.',

        'members' => [
            'zamzam' => [
                'name' => 'د. زمزم اللمكية',
                'role' => 'الإشراف العام لتطوير منصة قدرات - مديرة مشروع المنظومة الوطنية لبناء القدرات وإدارة المواهب',
            ],
            'sawsan' => [
                'name' => 'سوسن الحوسنية',
                'role' => 'الإشراف التقني',
            ...
            'maryam' => [
                'name' => 'مريم الهنائية',
                'role' => 'الإشراف الإداري',
            ],
            'hasnaa' => [
                'name' => 'جناب السمو حسناء آل سعيد',
                'role' => 'ترجمة المحتوى',
            ],
            'ahmad' => [
                'name' => 'أحمد البوسعيدي',
                'role' => 'التدقيق اللغوي للمحتوى',
            ],
            'mohammed' => [
                'name' => 'محمد المشايخي',
                'role' => 'البرمجة وتطوير المنصة',
            ],
        ],
    ],
