    ...
    <div class="container">
        <div class="flex justify-between gap-5 sm:gap-6 flex-wrap pb-20">
            <div class="w-full sm:w-5/12 xl:w-4/12 2xl:w-3/12">
                ...
                <p class="text-white mb-14">We’re always in search for talented and motivated people. Don’t be shy introduce yourself Subscribe news, exclusive offers & delivered right to your inbox!!</p>
                <h6 class="text-white text-base mb-2">Social Media</h6>
                <ul class="flex items-center gap-x-3">
                    <li>
                        <a href="https://www.facebook.com/" class="w-9 h-9 flex items-center justify-center rounded-full text-white bg-white bg-opacity-10 hover:bg-primary-1"><i class="ri-facebook-fill"></i></a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/" class="w-9 h-9 flex items-center justify-center rounded-full text-white bg-white bg-opacity-10 hover:bg-primary-1"><i class="lab la-youtube"></i></a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/" class="w-9 h-9 flex items-center justify-center rounded-full text-white bg-white bg-opacity-10 hover:bg-primary-1">
                                <span>
                                    <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5.273 0H0.5L6.132 7.71L0.807 14H2.614L6.969 8.856L10.727 14H15.5L9.631 5.966L14.682 0H12.875L8.794 4.82L5.273 0ZM11.409 12.6L3.227 1.4H4.591L12.773 12.6H11.409Z" fill="white"/>
                                    </svg>
                                </span>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/" class="w-9 h-9 flex items-center justify-center rounded-full text-white bg-white bg-opacity-10 hover:bg-primary-1"><i class="las la-basketball-ball"></i></a>
                    </li>
                </ul>
            </div>
