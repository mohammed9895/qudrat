                ...
                @foreach($category->posts as $post)
                    <div class="">
                        <div class="bg-white p-5 rounded-xl shadow-default">
                            ...
                            <a href="{{ route('digital-library.post', [$category,$post]) }}" class="inline-block px-8 py-3 rounded-full text-head-color font-medium bg-primary-1 text-white inline-flex items-center gap-2">View Resource</a>
                        </div>
                    </div>
                @endforeach
            </div>
