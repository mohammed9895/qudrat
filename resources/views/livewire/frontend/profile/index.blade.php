                ...
                <div class="col-span-full xl:col-span-3">
                    <div class="bg-white p-6 rounded-xl relative">
                        ...
                        <a href="#" class="px-8 py-3 rounded-full text-head-color font-medium bg-primary-2 text-white inline-flex items-center gap-2 w-full justify-center">
                                ...
                                <path d="M3.09502 10C3.03241 10.457 3 10.9245 3 11.4C3 16.7019 7.02944 21 12 21C16.9706 21 21 16.7019 21 11.4C21 10.9245 20.9676 10.457 20.905 10" stroke="white" stroke-width="2" stroke-linecap="round"/>
                                <path d="M12 13L12 3M12 13C11.2998 13 9.99153 11.0057 9.5 10.5M12 13C12.7002 13 14.0085 11.0057 14.5 10.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                </span>
                            Download CV
                        </a>
                ...
                <div class="col-span-full xl:col-span-9">
                                    ...
                                    <div class="col-span-full lg:col-span-4">
                                        ...
                                        <span>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M19 11V14.2611C19.1795 15.4395 19.8462 18.0707 22 20.091C21.2821 21.2694 18.8769 23.1213 15 21.1011" stroke="#141B34" stroke-width="1.5" stroke-linejoin="round"/>
                                                <path d="M5 11V14.2611C4.82051 15.4395 4.15385 18.0707 2 20.091C2.71795 21.2694 5.12308 23.1213 9 21.1011" stroke="#141B34" stroke-width="1.5" stroke-linejoin="round"/>
                   ...
                   @endif
                    ...
                    @if($profile->works()->count() > 0)
                        <div class="mt-7">
                            <h4 class="text-[28px] font-semibold mb-3">Work</h4>
