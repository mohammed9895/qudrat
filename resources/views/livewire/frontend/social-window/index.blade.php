            ...
            <div class="grid grid-cols-12 gap-5">
                <div class="col-span-full md:col-span-4 xl:col-span-3">
                    ...
                    <div class="bg-white p-6 rounded-xl mt-5">
                        ...
                        <h6 class="text-lg font-semibold mb-3 mt-3">{{ __('general.state') }}</h6>
                        <div class="">
                        ...
                        <h6 class="text-lg font-semibold mt-3 mb-3">{{ __('general.state') }}</h6>
                        <div class="">
                        ...
                        <h6 class="text-lg font-semibold mt-3 mb-3">{{ __('general.gender') }}</h6>
                        <div class="">
                        ...
                        <h6 class="text-lg font-semibold mt-3 mb-3">{{ __('general.education-level') }}</h6>
                        <div class="">
                            <select wire:model.live="educationType"
                                    class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none ">
                                <option value="">All</option>
                        ...
                        <h6 class="text-lg font-semibold mt-3 mb-3">{{ __('general.experience-level') }}</h6>
                        <div class="">
                            <select wire:model.live="experienceLevel"
                                    class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none ">
                                <option value="">All</option>
                ...
                <div class="col-span-full xl:col-span-9">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                        @foreach($this->profiles as $talent)
                            <div
                                class="bg-transparent border-[3px] border-white rounded-xl p-7 relative bg-white transition-all">
                                <div class="bg-primary-2 px-4 py-2 rounded-full absolute top-[-20px] right-[25px]">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        <p class="text-white text-sm">
                                            <span class="font-semibold">{{ $talent->rating() }}</span>
