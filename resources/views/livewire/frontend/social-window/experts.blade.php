        ...
        <div class="container">
            <div class="flex items-center justify-between gap-4 flex-wrap md:flex-nowrap">
                <div class="w-full md:w-6/12">
                    <x-breadcrumbs />
                    <h2 class="text-4xl sm:text-5xl font-semibold mb-3">Experts</h2>
                </div>
                <div class="w-6/12">
                </div>
            </div>
                ...
                <div class="bg-transparent border-[3px] border-white rounded-xl p-7 relative bg-white transition-all">
                    ...
                    <div class="flex flex-col justify-center items-center">
                        <div class="relative inline-block mb-4">
                            <div class="size-24 rounded-full" style="background: url({{$profile->getThumbnailImage()}}); background-size: cover; background-position: center center;"></div>
                        ...
                        <a href="{{ route('profile.index', $profile) }}" class="inline-block px-8 py-3 rounded-full border border-primary-1 text-head-color font-medium hover:bg-primary-1 hover:text-white">View Profile</a>
