<div>
    <!-- Banner -->
    <div class="bg-primary-3 pt-[160px] pb-28 relative overflow-hidden">
        <div class="container">
            <div class="flex items-center justify-between gap-4 flex-wrap md:flex-nowrap">
                <div class="w-full md:w-6/12">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <span class="text-gray-3 text-sm">/</span>
                        <span class="text-b-color text-sm">Contact</span>
                    </div>
                    <h2 class="text-4xl sm:text-5xl font-semibold mb-3">Get In touch</h2>
                </div>
                <div class="w-6/12">
                    <img src="assets/images/banner_4.png" alt="image" class="absolute h-full bottom-0 end-[16%] hidden lg:block">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-12 gap-4 lg:gap-7">
                ...
                <div class="col-span-full lg:col-span-4">
                    <div class="bg-white px-7 py-10 rounded-xl shadow-default h-full">
                        ...
                        <a href="#" class="inline-block px-8 py-3 rounded-full border border-primary-2 text-head-color font-medium hover:bg-primary-2 hover:text-white">Login for Billings</a>
                    </div>
                </div>
                <div class="col-span-full lg:col-span-4">
                    <div class="bg-white px-7 py-10 rounded-xl shadow-default h-full">
                        <img src="assets/images/contact_box_3.png" alt="image" class="mb-8">
                        <h5 class="text-xl font-semibold mb-3">General Questions or Feedback</h5>
                        <p class="mb-7">You can find more information on our FAQ, and Documentation pages.</p>
                        <ul class="flex flex-col gap-3 mb-14">
                            <li class="flex items-center gap-2">
                                    <span>
                                        <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="pt-12 pb-24">
        <div class="container">
            <div class="text-center mb-9">
                <h2 class="text-4xl sm:text-5xl font-semibold mb-3">Send US  a Message</h2>
                        ...
                        <div class="grid grid-cols-12 gap-4 lg:gap-6">
                            <div class="col-span-full lg:col-span-6">
                                <label for="name" class="block text-sm font-semibold mb-2">
                                    Frist Name: <span class="text-primary-2">*</span>
                                </label>
                                <input type="text" id="name" class="bg-white bg-opacity-50 w-full px-6 py-4 border border-gray-1 rounded-lg" placeholder="Name">
                            </div>
                            <div class="col-span-full lg:col-span-6">
                                <label for="email" class="block text-sm font-semibold mb-2">
                                    Email Address: <span class="text-primary-2">*</span>
                                </label>
                                <input type="email" id="email" class="bg-white bg-opacity-50 w-full px-6 py-4 border border-gray-1 rounded-lg" placeholder="Email">
                            </div>
                            <div class="col-span-full lg:col-span-6">
                                <label for="name" class="block text-sm font-semibold mb-2">
                                    Subject:
                                </label>
                                <input type="text" id="name" class="bg-white bg-opacity-50 w-full px-6 py-4 border border-gray-1 rounded-lg" placeholder="Enter Your Subject">
                            </div>
                            <div class="col-span-full lg:col-span-6">
                                <label for="text" class="block text-sm font-semibold mb-2">
                                    Phone:
                                </label>
                                <input type="text" id="email" class="bg-white bg-opacity-50 w-full px-6 py-4 border border-gray-1 rounded-lg" placeholder="Number">
                            </div>
                            <div class="col-span-full ">
                                <label for="text" class="block text-sm font-semibold mb-2">
                                    Message:
                                </label>
                                <textarea name="" id="" class="bg-white bg-opacity-50 w-full px-6 py-4 border border-gray-1 rounded-lg min-h-[150px]" placeholder="Please write details your Comment"></textarea>
                            </div>
                            <div class="col-span-full">
                                <div class="flex justify-center">
                                    <button type="submit" class="px-8 py-3 rounded-full  text-head-color font-medium bg-black text-white">Post Comment</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div class="">
        <div class="container">
            <div class="bg-b-bg py-24 relative z-10">
                <div class="flex justify-center mb-9">
                    <div class="lg:w-6/12">
                        <div class="text-center">
                            <h2 class="text-4xl sm:text-5xl font-semibold mb-3">Directly Contact  Us</h2>
                            <p>Deeply understand the technology and features  product area to which you are  product area to which you are assigned assigned.</p>
                        </div>
                    </div>
                </div>
                <div class="flex justify-center gap-5 flex-wrap md:flex-nowrap">
                        ...
                        <div class="bg-white px-7 py-9 rounded-xl group relative z-10 hover:bg-primary-2 transition-all">
                                <span class="absolute end-0 bottom-0 -z-10 group-hover:opacity-10">
                                    <svg width="251" height="154" viewBox="0 0 251 154" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="161.5" cy="161" r="161" fill="#EBF9F8"></circle>
                                    </svg>
                                </span>
