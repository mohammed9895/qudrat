...
<x-dynamic-component
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                @foreach($page->data['talents'] as $talent)
                                    <div class="swiper-slide relative pt-10"
        ...
        <div class="container">
            <div class="flex items-center justify-between gap-4 flex-wrap">
                <div class="w-full xl:w-5/12">
                    ...
                    <a
                        href="{{ $page->data['steps_button_url'] }}"
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <div
                                    ...
                                    <h4 class="text-5xl font-bold text-brand-red text-opacity-25 absolute top-1 end-1">
                                        {{ $step['number'] }}</h4>
                                    <img src="{{  Storage::disk('nfs')->url($step['image']) }}" alt="images"
                                         class="w-20 mb-3">
    ...
    {{--                <img src="{{  Storage::disk('nfs')->url($page->data['testimonials_image']) }}" alt="images"--}}
    ...
    {{--                                        <div class="shrink-0">--}}
    {{--                                            <img src="{{  Storage::disk('nfs')->url($testimonial['image']) }}"--}}
    {{--                                                 alt="image" class="">--}}
    {{--                                        </div>--}}
    {{--                                        <div>--}}
                            ...
                            <div class="bg-white px-7 py-5 rounded-xl hover:shadow-default transition-all">
                                <div class="flex items-center justify-between gap-4 flex-wrap">
                                    <div class="flex items-center gap-3">
                                        <div class="shrink-0">
                                            <img src="{{  Storage::disk('nfs')->url($feature['icon']) }}" alt="image"
                                                 class="">
                                        </div>
                                        <div>
            ...
            <div class="flex justify-center">
                <div class="xl:w-8/12">
                    <div id="accordion-flush" data-accordion="collapse"
                         data-active-classes="bg-white text-primary-1"
