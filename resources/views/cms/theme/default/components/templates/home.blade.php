                            ...
                            <div class="col-span-12 md:col-span-6">
                                <div
                                    ...
                                    <h4 class="text-5xl font-bold text-brand-red text-opacity-25 absolute top-1 end-1">
                                        {{ $step['number'] }}</h4>
                                    <img src="{{  Storage::disk('nfs')->url($step['image']) }}" alt="images" class="w-20 mb-3">
    ...
    <div class="py-12">
        <div class="container">
            <div class="rounded-lg relative">
                <img src="{{  Storage::disk('nfs')->url($page->data['testimonials_image']) }}" alt="images" class="min-h-[280px] w-full">
                            ...
                            <div class="swiper-slide">
                                <div class="bg-white p-7 rounded-2xl shadow-default">
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div class="shrink-0">
                                            <img src="{{  Storage::disk('nfs')->url($testimonial['image']) }}" alt="image" class="">
                                        </div>
                                        <div>
        ...
        <div class="container">
            <div class="flex items-center justify-between gap-4 flex-wrap">
                            ...
                            <div class="bg-white px-7 py-5 rounded-xl hover:shadow-default transition-all">
                                <div class="flex items-center justify-between gap-4 flex-wrap">
                                    <div class="flex items-center gap-3">
                                        <div class="shrink-0">
                                            <img src="{{  Storage::disk('nfs')->url($feature['icon']) }}" alt="image" class="">
                                        </div>
                                        <div>
                ...
                <div class="w-full xl:w-6/12 relative">
                    <div
                        class="w-[650px] h-[650px] absolute rounded-full border-dashed border-2 z-10 border-brand-green bg-brand-green/30 max-w-full">
                    </div>
